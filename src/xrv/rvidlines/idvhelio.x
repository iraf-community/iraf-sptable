...
int	dtm_decode()
double	s_getd(), obsgetd()
pointer	clopset()

int	err
data	err/0/

errchk	s_getd, s_gstr, obsopen
...
begin
	...
	iferr {
	    ...
	    call s_gstr (im, Memc[str1], Memc[str2], SZ_LINE)
